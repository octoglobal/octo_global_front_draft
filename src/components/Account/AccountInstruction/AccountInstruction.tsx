	...
	return (
		<WrapperMUI>
			...
			<ULMUI>
				...
				<LIMUI>Если товар превышает сумму беспошлинного ввоза (200 евро за посылку), предстоит процедура таможенного оформления, как при покупке напрямую в интернет-магазине.  </LIMUI>
