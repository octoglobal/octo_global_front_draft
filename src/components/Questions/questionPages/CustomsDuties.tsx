...
const CustomsDuties = () => {
	return (
		<ContainerMUI>
			...
			<ParagraphMUI>
				Количество посылок не ограничено. Проверить актуальную информацию и посмотреть полный расчет таможенных сборов можно проверить на сайте Федеральной таможенной службы.
			</ParagraphMUI>
		</ContainerMUI>
	);
};
